...
SPEC = {'source_fingerprint': 'bc2cc547f15430bc9af2ebdfba0b8cf1c73702e8fbea35d8b2953cc960da117b', 'width': 10800, 'height': 3600, 'visual_family': 'grouped_bar', 'observable_visual_grammar': {'panel_grid': [2, 4], 'panel_count': 8, 'aspect_class': 'wide', 'density': 'high', 'visual_family': 'grouped_bar'}, 'reconstruction_blueprint': {'blueprint_id': 'brainteaser_correctness_category', 'mosaic': ['AB', 'CD'], 'panel_recipes': [{'id': 'A', 'kind': 'bar:category'}, {'id': 'B', 'kind': 'bar:category'}, {'id': 'C', 'kind': 'distribution:points'}, {'id': 'D', 'kind': 'forest:effects'}], 'annotation_model': 'panel_letters + local_legends + direct_callouts', 'source_observation': 'category-level correctness panels with raw and interval evidence'}, 'renderer_version': 3}
