#!/usr/bin/env python3
"""Publication Figure Design cross-platform adapter generator.

Reads publication-figure-design/SKILL.md and generates platform-specific adapter files for:
...
def extract_core_rules() -> str:
    ...
    return f'''# Publication Figure Design Portable Core Rules
# Auto-generated from publication-figure-design/SKILL.md — {_now()}
...
def generate_claude_code(core: str) -> str:
    ...
    return f'''# Publication Figure Design — Claude Code Installation
...
def generate_codex_manifest(core: str) -> str:
    ...
    manifest = f'''# Publication Figure Design — OpenAI Codex Manifest
# Place this file at: ~/.codex/skills/publication-figure-design/manifest.yaml
# Generated: {_now()}
...
'''
    ...
    instructions = f'''# Publication Figure Design Instructions for Codex
# Auto-generated from publication-figure-design/SKILL.md — {_now()}
...
def generate_cursor_rules(core: str) -> str:
    ...
    return f'''# Publication Figure Design — Scientific Figure Making Rules
...
def generate_copilot_instructions(core: str) -> str:
    ...
    return f'''# Publication Figure Design — Scientific Figure Instructions for GitHub Copilot
...
def generate(target: str | None = None):
    ...
    print(f"Publication Figure Design Adapter Generator — {_now()}")
